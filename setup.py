...
#   Extension("util.enumerator", ["util/enumerator.pyx"]),
   ...
   Extension("parser.LCFRS.LCFRS_Parser_Wrapper", sources=["parser/LCFRS/LCFRS_Parser_Wrapper.pyx"], language='c++', extra_compile_args=["-std=c++11"], extra_link_args=["-std=c++11"])
]
